...
<div class="flex justify-between items-center mb-6">
    ...
    <a href="engineer_form.php" class="bg-cyan-600 hover:bg-cyan-700 text-white px-4 py-2 text-xs font-bold uppercase tracking-widest transition-colors">
        + Add New Unit
    </a>
</div>
        ...
        <tbody>
            ...
            <?php foreach ($engineers as $eng): ?>
                <tr class="bg-white border-b hover:bg-slate-50">
                    ...
                    <td class="px-6 py-4 font-bold text-slate-900"><?= htmlspecialchars($eng['role']) ?></td>
                    ...
                    <td class="px-6 py-4 flex gap-3">
                        <a href="engineer_form.php?id=<?= $eng['id'] ?>" class="text-cyan-600 hover:text-cyan-800 text-xs font-bold uppercase tracking-widest">Edit</a>
                        <a href="?delete=<?= $eng['id'] ?>" onclick="return confirm('Delete this unit?')" class="text-red-600 hover:text-red-800 text-xs font-bold uppercase tracking-widest">Delete</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
